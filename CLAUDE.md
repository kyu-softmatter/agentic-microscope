...
1443 passed, 11 skipped on macOS, of 1,454 (re-measured 2026-09-15; was
1374/11 of 1,385 on 2026-09-14, and the 69 added since are the plan emitter's,
stage 2's seam, and L1.3/L1.5 -- the emitter is where the next four broken
handoffs were found, one of them a number the run order already claimed to
carry. Windows printed 1195/10 on 2026-09-09 — one Windows-only test — and has

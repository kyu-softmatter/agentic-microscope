...
```text
  ...
  +---------------------------------+---------------------------------+
                                    v
  +-------------------------------------------------------------------+
  |  COMMITTEE               8 lenses . 31 gates (G1-G32, no G10)     |
  |                                                                   |
...
documents, 31 gates (G1–G32 less the vacant G10), 1,267 tests passing. The badge above reports
...
| [04 Decision engine](docs/04-decision-engine.md) | Decision order, photon budget / SNR / sampling / timing formulas, the 31 gates |
...
| [`photo/`](photo/) | 5 · photo-perturbation (G20–G22) | Implemented, and **computing since 2026-09-09** — power and illuminated area were measured that day, so irradiance exists at 20×. G10 was removed the same day ([04 §6](docs/04-decision-engine.md)). The transcript above is what it used to refuse, kept because [a refusal is still a valid result](#a-refusal-is-a-valid-result) |

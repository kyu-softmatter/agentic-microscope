...
```text
   ...
   29 gates       whether the setting is a good idea at all.
...
**the 29 gates are indifferent to it.** They consume physical quantities —
...
and cannot override a failed gate. 29 gates, none of which need the
instrument.
...
*whether the setting is a good idea* — the 29 gates sit above any transport and

...
```text
   ...
   27 gates       whether the setting is a good idea at all.
...
**the 27 gates are indifferent to it.** They consume physical quantities —
...
and cannot override a failed gate. 27 gates, none of which need the
instrument.
...
*whether the setting is a good idea* — the 27 gates sit above any transport and

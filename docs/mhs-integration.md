...
```text
   ...
   31 gates       whether the setting is a good idea at all.
...
**the 31 gates are indifferent to it.** They consume physical quantities —
...
and cannot override a failed gate. 31 gates, none of which need the
instrument.
...
*whether the setting is a good idea* — the 31 gates sit above any transport and

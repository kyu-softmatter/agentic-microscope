...
```text
   ...
   32 gates       whether the setting is a good idea at all.
...
**the 32 gates are indifferent to it.** They consume physical quantities —
...
and cannot override a failed gate. 32 gates, 1109 tests, none of which need the
instrument.
...
*whether the setting is a good idea* — the 32 gates sit above any transport and

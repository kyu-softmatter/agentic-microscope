...
```text
   ...
   30 gates       whether the setting is a good idea at all.
...
**the 30 gates are indifferent to it.** They consume physical quantities —
...
and cannot override a failed gate. 30 gates, none of which need the
instrument.
...
*whether the setting is a good idea* — the 30 gates sit above any transport and

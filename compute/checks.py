...
TOLERANCE: dict[str, float] = {
    #: L3.4. The 5 s buffer floor is a chosen depth, not a device limit:
    #: below it a transient disk stall starts dropping frames sooner,
    #: which is a shorter grace period and not a broken acquisition.
    "buffer.too_small": 0.5,
}
